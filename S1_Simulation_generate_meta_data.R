...
save(output, file="niceResults_Paper_Rcode/Simulation_generate_meta_data_1.rda")

r<-loadRegistry("../scratch/MetaC/Simulation_generate_meta_data_2")
getStatus(reg=r)
results<-reduceResultsList(reg=r)
output<-niceResults(results)
save(output, file="simulation/Simulation_generate_meta_data_2.rda")

r<-loadRegistry("../scratch/MetaC/Simulation_generate_meta_data_3")
getStatus(reg=r)
results<-reduceResultsList(reg=r)
output<-niceResults(results)
save(output, file="simulation/Simulation_generate_meta_data_3.rda")
